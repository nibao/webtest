...
const ErrorKeyHash = {
    ...
    [ErrorCode.URIFormatIllegal]: '非法URI参数',
    [ErrorCode.JSONFormatIllegal]: '非法JSON字符串',
    ...
    [ErrorCode.LocalTimeInvalid]: '您设置的时间已经早于服务器的当前时间，请重新设置或校对时间。',
    [ErrorCode.ExpirationInvalid]: '您设置的有效期已经超过了5年的限制，请重新设置或校对时间。',
    [ErrorCode.NameInvalid]: '标签名不能包含 / : * ? " < > | 特殊字符，请重新输入',
    [ErrorCode.PermConfigExpired]: '您设置的权限有效期限已经早于服务器的当前时间，请重新设置或校对时间。',
    [ErrorCode.LinkConfigExpired]: '您设置的链接有效期限已经早于服务器的当前时间，请重新设置或校对时间。',
    [ErrorCode.TokenExpired]: '登录已超时',
    [ErrorCode.LinkAuthFailed]: '外链密码不正确',
    ...
    [ErrorCode.PasswordInvalid]: '新密码格式不正确，请输入10-32个字符，且只能包含大小写字母、数字及~`!@#$%-_,.特殊字符',
    [ErrorCode.PasswordWeak]: '新密码格式不正确，请输入10-32个字符，需同时包含大小写字母及数字，支持~`!@#$%-_,.特殊字符',
    [ErrorCode.PasswordChangeNotSupported]: '当前用户为外部用户，不支持修改密码',
    [ErrorCode.PasswordIsInitial]: '无法使用初始密码登录，是否立即修改密码？',
    [ErrorCode.PasswordInvalidOnce]: '您已输错1次密码，连续输错3次将导致账号被锁定',
    [ErrorCode.PasswordInvalidTwice]: '您已输错2次密码，连续输错3次将导致账号被锁定',
    [ErrorCode.PasswordInvalidLocked]: '您输入错误次数超过限制，账号已被锁定，1小时内无法登录，请稍后重试',
    ...
    [ErrorCode.AccountLocked]: '您输入错误次数超过限制，账号已被锁定，请联系安全管理员',
    ...
    [ErrorCode.LinkDuplicated]: '外链已经存在',
    ...
    [ErrorCode.PublicShareDuplicated]: '当前目录已经开启或关闭发现共享，导致操作失败',
    [ErrorCode.ParentPublicShareEnabled]: '父目录已经开启或关闭发现共享，导致操作失败',
    ...
    [ErrorCode.NameDuplicatedReadonly]: '存在与当前文件“${filename}”同名的文件但无修改权限',
    [ErrorCode.DiffTypeNameDuplicated]: '与当前文件“${filename}”同名的是一个文件夹。',
    [ErrorCode.TrancodeFormatUnsupported]: '转码失败，文件格式不支持',
    [ErrorCode.PermissionMismath]: '没有权限操作目标位置的对象',
    [ErrorCode.LinkRestricted]: '您没有外链共享权限，请联系管理员。',
    [ErrorCode.CSFLevelMismatch]: '您的密级不足。',
    [ErrorCode.TranscodeSpaceExhausted]: '转码失败，服务器缓存空间不足',
    [ErrorCode.DocumentSizeExceeded]: '文件“${filename}”过大，无法同步，您所在的网络存在限制。',
    [ErrorCode.ApplyAuditMissing]: '当前无匹配审核员，本次操作无法生效，请联系管理员。',
    [ErrorCode.ShareApplyComplete]: '此条记录已失效或被其他审核员审核完成。',
    [ErrorCode.ShareApplyInvalid]: '您的审核权限已失效。',
    [ErrorCode.ShareApplyAccessorInaccessible]: '此条申请已经失效（访问者已经被删除）',
    [ErrorCode.ApplyDenyConcentMissing]: '否决申请时，内容不能为空',
    [ErrorCode.ShareApplySharerInaccessible]: '此条申请已失效（共享者已经被删除）',
    [ErrorCode.ShareApplyExpired]: '此条申请已失效（截止时间已经过期）',
    [ErrorCode.LinkApplyInvalid]: '此条申请已失效（外链已失效）',
    [ErrorCode.LinkApplyDuplicated]: '此条申请已失效（外链已存在）',
    [ErrorCode.AuditCSFMismatch]: '当前审核员密级不足，本次操作无法生效，请联系管理员。',
    ...
    [ErrorCode.ShareExpirationExpired]: '您设置的权限有效期限已经早于服务器的当前时间，请重新设置或校对时间。',
    [ErrorCode.LinkExpirationExpired]: '您设置的链接有效期限已经早于服务器的当前时间，请重新设置或校对时间。',
    [ErrorCode.LinkExpirationConflict]: '链接有效期限不能大于权限有效期限。',
    [ErrorCode.CommentSubmitDisabled]: '发表失败，评论功能没有正常启用，请联系管理员。',
    [ErrorCode.CommentDeleteDisabled]: '删除失败，评论功能没有正常启用，请联系管理员。',
    ...
    [ErrorCode.PersonalShareUnauthorized]: '您没有共享个人文档权限，无法进行权限配置。',
    [ErrorCode.GroupShareUnauthorized]: '您没有共享群组文档权限，无法进行权限配置。',
    [ErrorCode.PersonalInvitationUnauthorized]: '您没有共享个人文档权限，无法开启共享邀请。',
    [ErrorCode.GroupInvitationUnauthorized]: '您没有共享群组文档权限，无法开启共享邀请。',
    [ErrorCode.PersonLinkUnauthorized]: '您没有共享个人文档权限，无法开启外链。',
    [ErrorCode.GroupLinkUnauthorized]: '您没有共享群组文档权限，无法开启外链。',
    [ErrorCode.PersonLinkModificationUnauthorized]: '您没有共享个人文档权限，无法修改外链。',
    [ErrorCode.GroupLinkModificationUnathorized]: '您没有共享群组文档权限，无法修改外链。',
    [ErrorCode.PersonalInvitationModificationUnauthorized]: '您没有共享个人文档权限，无法修改共享邀请。',
    [ErrorCode.GroupInvitationModificationUnauthorized]: '您没有共享群组文档权限，无法修改共享邀请。',
    [ErrorCode.AccountFrozen]: '您的账号已被冻结。',
    [ErrorCode.DocumentFrozen]: '该文档已被冻结。',
    [ErrorCode.GroupInaccessible]: '群组不存在',
    [ErrorCode.DeparmentInaccessible]: '获取子部门或子用户信息时，指定部门不存在',
    ...
    [ErrorCode.GNSInaccessible]: '文件或文件夹“${filename}”不存在, 可能其所在路径发生变更。',
    [ErrorCode.LinkInaccessable]: '外链地址已失效。',
    ...
    [ErrorCode.NotNullGroup]: '当前群组文档中存有数据，请先将其迁移后再进行删除操作。',
    [ErrorCode.GroupNameInvalid]: '群组名不合法，可能字符过长或包含 \ / : * ? " < > | 特殊字符。',
    [ErrorCode.UserdocMissing]: '您已被关闭个人文档，无法使用此功能。',
    [ErrorCode.ResourcesNotEnough]: '服务器资源不足，无法访问。',
    [ErrorCode.EmailInvalid]: '邮箱地址只能包含 英文、数字 及 @-_. 字符，格式形如 XXX@XXX，长度范围 3~100 个字符，请重新输入。',
    ...
    [ErrorCode.DeleteOutboxDisabled]: '无法执行重命名操作。您没有对发送文件箱目录的操作权限。'
}

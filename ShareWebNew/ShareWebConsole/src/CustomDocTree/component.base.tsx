...
export default class CustomDocTreeBase extends WebComponent<Console.CustomDocTree.Props, Console.CustomDocTree.State> {
    static defaultProps = {
    ...
    private getRoots(key = ''): Promise<any> {
        ...
        return EACP('EACP_SearchCustomDocInfos', [params]);
    }

...
import PopularListBase from './component.base';
...
export default class PopularList extends PopularListBase implements PopularList {
    render() {
        return (
            <div className={styles['container']}>
                <div className={styles['header']}>
                    <Icon url={titleIcon} size={16}></Icon>
                    <label className={styles['title']}>{__('热点知识')}</label>
                </div>

...
import MoveToBase, { MoveStatus } from './component.base'
...
export default class MoveTo extends MoveToBase {
    ...
    render() {
        ...
        return (
            <div>
                <Drawer mask={true} open={status === MoveStatus.Pick}>
                    <DocSelector
                        title={(s, dir) => `移动到到“${dir ? docname(dir) : '文档'}”`}
                        className={styles['selector']}
                        selectType={0}
                        multiple={false}
                        onConfirm={this.move.bind(this)}

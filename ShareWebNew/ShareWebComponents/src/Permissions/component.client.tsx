...
const Item = ({ record, name, isCurUser }) => (
    <div className={styles['item']}>
        ...
        <div className={classnames(styles['permission-form'], isCurUser ? styles['bold'] : null)}>
            <Text>
                {
            ...
            <div className={styles['container']}>
                {
                    this.state.permConfigs.map((permConfig) => (
                        <Item record={permConfig} name={this.formatterName(permConfig.accessorname)} isCurUser={userid === permConfig.accessorid} />
                    ))
                }
            </div>
        )

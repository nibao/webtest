...
import MyAccessListBase from './component.base';
...
export default class MyAccessList extends MyAccessListBase implements MyAccessList {
    render() {
        return (
            <div className={styles['container']}>
                <div className={styles['header']}>
                    <Icon url={titleIcon} size={16}></Icon>
                    <label className={styles['title']}>{__('我的最近访问')}</label>
                </div>
                            ...
                            <div className={styles['docs']}>
                                ...
                                >
                                    ...
                                    <DataGrid.Field
                                        ...
                                        formatter={access_time => formatTimeRelative(access_time / 1000)}
                                    />

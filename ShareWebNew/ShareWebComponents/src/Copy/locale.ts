...
export default i18n([
    [
        ...
        '复制并保留，当前文件重命名为“${newname}”',
        '複製並保留，當前檔案重命名為“${newname}”',
        'Keep both and rename this file as "${newname}"'
    ], [
        '复制并保留，当前文件夹重命名为“${newname}”',
        '複製並保留，當前資料夾重命名為“${newname}”',
        ...
        '您对文件“${docname}”没有复制权限。',
        '您對檔案“${docname}”沒有複製權限。',
        'You do not have Copy permission for the file "${docname}".'
    ], [
        '您对文件夹“${docname}”没有复制权限。',
        '您對資料夾“${docname}”沒有複製權限。',
        'You do not have Copy permission for the folder "${docname}".'
    ], [
        ...
        '复制并合并，将当前文件夹与同名文件夹合并',
        '複製併合併，將當前資料夾與同名資料夾合併',
        ...
        'The same name file "${docname}" has been locked by "${locker}".'
    ], [
        ...
        '您对水印目录下的文件“${docname}”没有修改权限，无法将水印文件复制到水印目录范围外。',
        '您對浮水印目錄下的檔案“${docname}”沒有修改權限，無法將浮水印檔案複製到浮水印目錄範圍外。',

...
import ResultBox from './ResultBox/component.client';
    ...
    render() {
        ...
        return (
            <div className={styles['full-search']}>
                ...
                <div
                    className={classnames(styles['result-container'], styles['result-container-client'], {
                ...
                >
                    ...
                    <ResultBox
                        ...
                        onShareDocChange={(type, doc) => this.props.onShareDocChange(type, doc)}
                    />

    ...
    anyshare_userInfo:function(userid,tokenid,callback){
        ...
        Request({
            ...
            onComplete: function (response) {
                ...
                console.log("anyshare_userInfo:onComplete:status" + response.status
                    +"data:"+ response.text );
                if(response.status == 200){
                    result.data = response.json;
                    result.status = 0;
    ...
    anyshare_getEntryDoc:function(userid,tokenid,callback){
        ...
        Request({
            ...
            onComplete: function (response) {
                ...
                console.log(service_host + "v1/entrydoc?method=get&userid=" + userid + "&tokenid=" + tokenid);
                console.log("anyshare_getEntryDoc:onComplete:status" + response.status
                    +"data:"+ response.text );
                if(response.status == 200){
    ...
    anyshare_getFileList : function(userid,tokenid,docid,callback){
        ...
        Request({
            ...
            onComplete: function (response) {
                ...
                console.log("anyshare_getFileList:onComplete:status" + response.status
                    +"data:"+ response.text );
                if(response.status == 200){
                    var data = response.json;
    ...
    anyshare_permCheck : function(userid,tokenid,docid,perm,callback){
        ...
        Request({
            ...
            onComplete: function (response) {
                ...
                console.log("anyshare_permCheck:onComplete:status" + response.status
                    +"data:"+ response.text );
                if(response.status == 200){
                    result.data = response.json;//data.result = 0 有权限
                    result.status = 0;
                }
                else{
                    if(response.json){
            ...
            if (result.status == 0 && result.data.result == 0) {
                ...
                Request({
                    ...
                    onComplete: function (response) {
                        ...
                        console.log("anyshare_createFolder:onComplete:status" + response.status
                            + "data:" + response.text);
                        if (response.status == 200) {
                            var data = response.json;
                            data.Canlist = true;
            ...
            if (result.status == 0 && result.data.result == 0) {
                ...
                Request({
                    ...
                    onComplete: function (response) {
                        ...
                        console.log("anyshare_folderRename:onComplete:status" + response.status
                            + "data:" + response.text);
                        if (response.status == 200) {
                            result.data = response.json;
